                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[0]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                    ...
                                    <Collapse in={openItems[1]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                ...
                                                <p>Headless CMS are also particularly suitable for websites designed using the <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Jamstack</span> model where JavaScript, APIs, and Markup work together to make web development easier and user experiences better.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                                    ...
                                    <Collapse in={openItems[2]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                ...
                                                <p>The <span className='text-[#7e43e6] hover:text-[#4e26e0]'>API Endpoints documentation</span> will give you all the keys in hand to interact with your Strapi API.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[3]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>Traditional use cases include <span className='text-[#7e43e6] hover:text-[#4e26e0]'>static websites, mobile apps, e-commerce, editorial</span> and <span className='text-[#7e43e6] hover:text-[#4e26e0]'>corporate websites</span>. However, you can use Strapi to build any type of content-oriented applications including delivery to portable IoT devices or internal tools.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[5]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>*Yes**, you can get access to a hosted Strapi project containing existing content types and data for you to play with by requesting a <span className='text-[#7e43e6] hover:text-[#4e26e0]'>demo</span>.</p>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[9]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p><span className='font-semibold'>Yes!</span> We are using Product Board for our official <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Roadmap and feature requests</span>. Feel free to browse them.</p>
                                                <p>You can also subscribe to our <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Product updated newsletter</span>.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[10]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>It usually takes developers less than 5 minutes to get up and running with Strapi. You can easily follow our <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Quick start</span> to get started.</p>
                                                <p><span className='text-[#7e43e6] hover:text-[#4e26e0]'>As a developer</span>, it will take a few hours to get familiar with the source code, admin panel, and more advanced concepts to customize or integrate Strapi with other tools.</p>
                                                <p><span className='text-[#7e43e6] hover:text-[#4e26e0]'>As a content editor</span> you are using an admin panel which has a simple interface, so you can easily get used to it in less than an hour.</p>
                                                <p>You're not alone though, Strapi has an engaged and welcoming community that writes tutorials and helps each other out. Enroll in the <span className='text-[#7e43e6] hover:text-[#4e26e0]'>academy</span> and learn the fundamentals of Strapi in 3h.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[11]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>Yes! <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Developer docs</span>.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[12]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p><span className='font-semibold'>Yes!</span> You can find the User guide <span className='text-[#7e43e6] hover:text-[#4e26e0]'>here</span>.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[21]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p><span className='font-semibold'>Yes!</span> You can browse official and community tutorials by following this <span className='text-[#7e43e6] hover:text-[#4e26e0]'>link.</span></p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[13]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>Strapi is actively sponsored and maintained by Strapi, Inc the company behind the Strapi open-source project. Visit <span className='text-[#7e43e6] hover:text-[#4e26e0]'>the company page</span> to learn more about the company and the team.</p>
                                                <p>Without forgetting our <span className='text-[#7e43e6] hover:text-[#4e26e0]'>awesome</span> community which brings us enormously every day.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[14]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>Yes! Strapi is published under a standard MIT license. We're developing Strapi in the open, maintaining a public <span className='text-[#7e43e6] hover:text-[#4e26e0]'>product roadmap</span>, and using a <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Request for Changes</span> repository to create consensus among the core team and community.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[15]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p><span className='font-semibold'>Yes!</span> Feel free to contribute to our <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Github repository</span>. You'll be able to contribute under the <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Contributor License Agreement</span> (CLA).</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                                    ...
                                    <Collapse in={openItems[16]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                ...
                                                <p>If you want to learn more about Headless CMS, have a look at this extensive <span className='text-[#7e43e6] hover:text-[#4e26e0]'>guide</span>.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[18]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p><span className='font-semibold'>Yes!</span> The admin panel is easily customizable as well as the API. You can also extend your project with <span className='text-[#7e43e6] hover:text-[#4e26e0]'>custom plugins</span> in few seconds.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[19]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>We have an <span className='text-[#7e43e6] hover:text-[#4e26e0]'>awesome-strapi</span> Github repository that lists useful resources that can be used in your Strapi project. Feel free to browse the <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Plugin & Providers section</span>.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[20]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>Please join our <span className='text-[#7e43e6] hover:text-[#4e26e0]'>official forum</span> if you have any questions or if you want to start a discussion. If you want to learn more about Headless CMS, have a look at this <span className='text-[#7e43e6] hover:text-[#4e26e0]'>extensive guide</span>.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[23]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>The plan you choose will depend on your needs. We advise you to make your choice by looking at our comparison table on our <span className='text-[#7e43e6] hover:text-[#4e26e0]'>pricing page</span>.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[24]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p><span className='font-semibold'>Yes!</span> You can try our Bronze and Silver plans for free. Have a look at our <span className='text-[#7e43e6] hover:text-[#4e26e0]'>pricing page</span> to get started.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[26]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>Thousands of companies such as <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Delivery Hero, Societe Generale</span> and <span className='text-[#7e43e6] hover:text-[#4e26e0]'>IBM</span> are using Strapi in production today. Check out our <span className='text-[#7e43e6] hover:text-[#4e26e0]'>showcase</span> to see more examples.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[28]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>Yes! Feel free to <span className='text-[#7e43e6] hover:text-[#4e26e0]'>request a free bronze plan</span> if you match these criteria.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[30]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>Absolutely! Feel free to browse our <span className='text-[#7e43e6] hover:text-[#4e26e0]'>open positions.</span></p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[31]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>Yes! We do have a <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Write for the community</span> program which aims at gathering writers, video makers to create educational content for the community.</p>
                                                <p>More information <span className='text-[#7e43e6] hover:text-[#4e26e0]'>here</span>.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[33]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p><span className='font-semibold'>Yes!</span> We have an <span className='text-[#7e43e6] hover:text-[#4e26e0]'>official Dicord server</span> for you to come chat with us and the community.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[34]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p><span className='font-semibold'>Yes!</span> You can follow the instructions on this <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Github repository</span> to get started!</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[35]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                            <p><span className='font-semibold'>Yes!</span> Feel free to browse our <span className='text-[#7e43e6] hover:text-[#4e26e0]'>official showcase</span> and <span className='text-[#7e43e6] hover:text-[#4e26e0]'>user stories.</span></p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[36]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p><span className='font-semibold'>Yes!</span> <span className='text-[#7e43e6] hover:text-[#4e26e0]' >Buffet.js</span> is the React component library made with styled-component which is used in Strapi.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                                    ...
                                    <Collapse in={openItems[37]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                ...
                                                <p>Headless CMS represent the future of content delivery. Learn more about Headless CMS with our <span className='text-[#7e43e6] hover:text-[#4e26e0]'>2021 Headless guide</span>.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                                    ...
                                    <Collapse in={openItems[38]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                ...
                                                <p>Have a look at this <span className='text-[#7e43e6] hover:text-[#4e26e0]'>article</span> to learn more.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[39]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>With <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Jamstack</span>, the entire front end is prebuilt into highly optimized static pages and assets during a build process.</p>
                                    ...
                                    <Collapse in={openItems[40]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                ...
                                                <p>Have a look at <span className='text-[#7e43e6] hover:text-[#4e26e0]'>this article</span> to learn more about different static site generators.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[41]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p><span className='font-semibold'>Yes</span>, you can absolutely use Strapi for managing the content of your <span className='text-[#7e43e6] hover:text-[#4e26e0]'>Ruby, Python, React, Nuxt.js, Gatsby, Gridsome</span> (and more...) project. See our <span className='text-[#7e43e6] hover:text-[#4e26e0]'>integration</span> documentation for integrating you favorite stack with Strapi.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
                            ...
                            <div className='p-[10px]' >
                                <List component="nav" aria-labelledby="nested-list-subheader">
                                    ...
                                    <Collapse in={openItems[42]} timeout="auto" unmountOnExit>
                                        <ListItemIcon >
                                            <div className="text-[19px] text-[#344b80] px-[15px] leading-relaxed pb-[33px] font-normal">
                                                <p>We have an <span className='text-[#7e43e6] hover:text-[#4e26e0]'> awesome-strapi</span> Github repository that list useful resources that can be used in your Strapi project. Feel free to browse the <span className='text-[#7e43e6] hover:text-[#4e26e0]'> Plugin & Providers section</span>.</p>
                                            </div>
                                        </ListItemIcon>
                                    </Collapse>
                                </List>
